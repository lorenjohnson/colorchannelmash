Feature: Source files lists (Apple Photos static export list)  / ingredients list
Feature: Effects for single source AND final effects
Feature: Effects that span multiple frames on a source
